<div class="relative">
    ...
    <div class="relative w-full bg-gradient-to-b from-[#B80C09]/10 to-transparent pt-8 pb-12 px-4">
        <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-[#040F16] mb-6 drop-shadow-sm">Ignite Your Next Big Idea.</h1>
            
            {{-- Search Bar (Glass Style) --}}
            <div class="relative max-w-2xl mx-auto">
                <div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                    <svg class="h-6 w-6 text-[#B80C09]/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <input 
                    ...
                    class="w-full glass bg-white/60 pl-14 pr-6 py-4 rounded-2xl text-lg text-[#040F16] placeholder-[#0B4F6C]/40 focus:ring-4 focus:ring-[#B80C09]/20 focus:border-[#B80C09]/50 transition duration-300 shadow-xl backdrop-blur-xl"
                >
            </div>
        </div>
    </div>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200/50">
                        <form wire:submit.prevent="addTopic" class="relative">
                            <input 
                                ...
                                class="w-full bg-white/50 border border-gray-200 rounded-lg py-2 pl-3 pr-8 text-sm focus:ring-1 focus:ring-[#B80C09] focus:border-[#B80C09]"
                            >
